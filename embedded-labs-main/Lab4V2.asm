...
.org 0x0002 ; External interrupt request 0, pin D2

.org 0x0004 ; External interrupt request 0, pin D3

.org 0x0006 ; Pin change interrupt request
rcall OVF0addr
...
;r16: free use r17: r18: r19: r20:timer temp r21:timer temp r22:timer count r23:5mil loop r24: r25: r26: r27: r28: r29: r30: r31
...
main:
;Button Functions
sbis PINB,4 ;sbis=Skip if Bit is Set="if the 'button' is pressed, do the next line"
rcall buttonPressed

rcall wait0_1s
;rcall LED_status_check

sbic PINB,4 ;sbic = Skip if Bit Is Cleared="if the 'button' is NOT pressed, do the next line"

;RPG Functions
SBIS PINB,0
rcall checkModeCCW ;channel b,

SBIS PINB,1
rcall checkModeCW ;channel a

rcall checkDirection
rjmp main

buttonPressed:
;ldi free_use,LED_status
rcall toggleMode
button_down:
;ldi free_use,LED_status
sbis PINB,4
...
toggleMode: ;change the type of mode the LED is in
cpi free_use, 0
breq turn_on_LED
cpi free_use, 1
breq turn_off_LED
...
checkModeCCW: ;these check functions will determine if the mode is 2, so that it is adjustable
cpi R18,2
breq ccwDirection
ret
checkModeCW:
...
breq cwDirection
ret
ccwDirection: ;set the direction to 1 or 2, ccw
ldi R26,1
ret
cwDirection:
ldi R26,2
...
inc R30
rcall delayCS
rcall delayCS ;rcall delaySecond
ldi R26,0
ret
turnCCW:
dec R30
